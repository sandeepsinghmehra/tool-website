...
export const metadata: Metadata = {
  ...
  keywords: ["text repeater", "duplicate text", "repeat text online", "text duplicator", "text multiplier", "online text repeater", "free text repeater", "text replication", "text repeater online", "text repeater copy and paste", "repeating text generator", "text repeater whatsapp", "text repeater for instagram"],
};
